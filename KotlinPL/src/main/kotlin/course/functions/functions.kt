 ...
 */
private fun unitReturningFunction(a: Int, b: Int) {
 ...
 */
private fun functionWithDefaultValue(a: Int = 10, b: Int = 10) {
 ...
 */
private fun singleExpressionFunction(a: Int, b: Int) = a + b
/**
 *  Vararg functions
 ...
 */
private fun varargFunction(vararg numbers: Int) = numbers.forEach(::print)
/**
 *  Infix functions
 ...
 */
private infix fun String.times(n: Int) {
...
fun main() {
    ...
    val b = readlnOrNull()?.toIntOrNull() ?: 20
    unitReturningFunction(a, b)
    functionWithDefaultValue(b = 20)
    println(singleExpressionFunction(a, b))
    varargFunction(1, 2, 3, a, b)
    println()
